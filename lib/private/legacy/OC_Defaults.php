...
class OC_Defaults {
	...
	public function __construct() {
		...
		$this->defaultEntity = 'VIM'; /* e.g. company name, used for footers and copyright notices */
		$this->defaultName = 'VIM'; /* short name, used when referring to the software */
		$this->defaultTitle = 'VIM'; /* can be a longer name, for titles */
		$this->defaultBaseUrl = 'https://www.vimaec.com/';
		$this->defaultSyncClientUrl = $config->getSystemValue('customclient_desktop', '');
		$this->defaultiOSClientUrl = $config->getSystemValue('customclient_ios', '');
		$this->defaultiTunesAppId = $config->getSystemValue('customclient_ios_appid', '');
		$this->defaultAndroidClientUrl = $config->getSystemValue('customclient_android', '');
		$this->defaultFDroidClientUrl = $config->getSystemValue('customclient_fdroid', '');
		$this->defaultDocBaseUrl = 'https://www.vimaec.com/';
		$this->defaultDocVersion = \OC_Util::getVersion()[0]; // used to generate doc links
		$this->defaultColorPrimary = '#0082c9';
		$this->defaultTextColorPrimary = '#ffffff';
		$this->defaultProductName = 'VIMAEC';
